...
- Details: contains Tanudisastro2024_LocusId (original locus ID, may differ if fuzzy matched)
  and per-cell-type information (pvalue, effectSize, eGene, rank, totalInCellType)
"""
...
def main():
    ...
    for trexplorer_locus_id, candidates in trexplorer_candidates.items():
        ...
        # Build details dict with LocusId and per-cell-type info, sorted by p-value
        ...
        output_lookup[trexplorer_locus_id] = {
            "SignificantCellTypes": ",".join(k for k in details.keys() if k != "Tanudisastro2024_LocusId"),
