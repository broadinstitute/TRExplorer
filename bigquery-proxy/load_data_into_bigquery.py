...
parser.add_argument("-c", "--catalog-path", help="Path to the annotated catalog JSON file",
                    ...
                    default="~/code/tandem-repeat-catalogs/results__2025-11-22/release_draft_2025-11-22/repeat_catalog_v2.hg38.1_to_1000bp_motifs.EH.with_annotations.json.gz")
...
schema = [
    ...
    bigquery.SchemaField("TenK10K_StdevRankByMotif", "INTEGER"),
    bigquery.SchemaField("TenK10K_StdevRankTotalNumberByMotif", "INTEGER"),
    ...
    bigquery.SchemaField("HPRC100_StdevRankByMotif", "INTEGER"),
    bigquery.SchemaField("HPRC100_StdevRankTotalNumberByMotif", "INTEGER"),
    ...
    bigquery.SchemaField("AoU1027_StdevRankByMotif", "INTEGER"),
    bigquery.SchemaField("AoU1027_StdevRankTotalNumberByMotif", "INTEGER"),
    ...
    bigquery.SchemaField("NonCodingAnnotations", "STRING"),
    ...
    bigquery.SchemaField("ReferenceLeftFlank", "STRING"),
    bigquery.SchemaField("ReferenceRightFlank", "STRING"),
]
...
for i, record in tqdm.tqdm(enumerate(catalog), unit=" records", unit_scale=True):
    ...
    if record["LocusId"] in hprc100_lookup:
        ...
        record["HPRC100_MaxAllele"] = hprc100_record["max_allele"]
        record["HPRC100_UniqueAlleles"] = hprc100_record["unique_alleles"]
