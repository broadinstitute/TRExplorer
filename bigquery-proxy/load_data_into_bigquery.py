...
parser.add_argument("--tanudisastro-2024-lookup-json",
                    default="../data-prep/columns_from_literature_review/Tanudisastro_2024/Tanudisastro_2024_lookup.json.gz",
                    help="JSON lookup with sc-eTR data from Tanudisastro et al. 2024")
parser.add_argument("--manigbas-2024-lookup-json",
                    default="../data-prep/columns_from_literature_review/Manigbas_2024/Manigbas_2024_lookup.json.gz",
