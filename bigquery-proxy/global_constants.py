...
MAIN_BIGQUERY_TABLE_COLUMNS = [
    ...
    {
        "type": "FLOAT",
        "name": "TenK10K_ShortAllele99thPercentile",
        "description": "99th percentile of the shorter-of-paired allele size per sample in TenK10K Phase 1.",
        "displayName": "TenK10K Short Allele 99th Percentile",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_TENK10K,
    },
    {
        "type": "INTEGER",
        "name": "TenK10K_ShortAlleleMax",
        "description": "Maximum shorter-of-paired allele size per sample in TenK10K Phase 1.",
        "displayName": "TenK10K Short Allele Max",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_TENK10K,
    },
    ...
    {
        "type": "FLOAT",
        "name": "HPRC256_ShortAllele99thPercentile",
        "description": "99th percentile of the shorter-of-paired allele size (LPS) per sample in HPRC256.",
        "displayName": "HPRC256 Short Allele 99th Percentile",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_HPRC256,
    },
    {
        "type": "INTEGER",
        "name": "HPRC256_ShortAlleleMax",
        "description": "Maximum shorter-of-paired allele size (LPS) per sample in HPRC256.",
        "displayName": "HPRC256 Short Allele Max",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_HPRC256,
    },
    {
        "type": "FLOAT",
        "name": "HPRC256_HemiAllele99thPercentile",
        "description": "99th percentile allele size (LPS) among male samples only, for loci on chrX or chrY (hemizygous calls) in HPRC256. Null for autosomal loci.",
        "displayName": "HPRC256 Hemi Allele 99th Percentile",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_HPRC256,
    },
    {
        "type": "INTEGER",
        "name": "HPRC256_HemiAlleleMax",
        "description": "Maximum allele size (LPS) among male samples only, for loci on chrX or chrY (hemizygous calls) in HPRC256. Null for autosomal loci.",
        "displayName": "HPRC256 Hemi Allele Max",
        "allowCustomFilter": True,
        "allowExport": True,
        "group": GROUP_POLYMORPHISM_HPRC256,
    },
